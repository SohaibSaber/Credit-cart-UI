        ...
        child: Column(
          children: [
            ...
            Container(
                ...
                child: Column(
                  children: [
                    MyLoginField(hint: 'Current Password',hintColor: Colors.black),
                    SizedBox(height: 15,),
                    MyLoginField(hint: 'New Password',hintColor: Colors.black,),
                    SizedBox(height: 15,),
                    MyLoginField(hint: 'Repeat New Password', hintColor: Colors.black,),
                    SizedBox(height: 270,),
                    InkWell(
                        onTap: () {
                          Get.back();
